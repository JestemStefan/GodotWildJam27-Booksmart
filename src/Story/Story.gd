...
var text_blurbs := [
	...
	"- Story -\n\nHelp Paige serve her customers the books they’re after, all the while watching out for your weird woody workmate. Who knows, maybe if you abate his hunger, he’ll leave you alone! The question is, are you smart enough to run this store?",
