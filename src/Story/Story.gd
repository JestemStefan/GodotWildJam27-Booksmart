...
var text_blurbs := [
	"- Story -\n\nAh, the book exchange- a safe haven for books and book lovers alike. But nothing disturbs the peace and quiet of a book-house quite like a book-eating barrel bin!",
	...
	"- Story -\n\nEmbarking on the next chapter of her life, she’s just landed the highly coveted position of Book Dispatcher at an outlet of the acclaimed chain store, BooksMart.\nHowever, Paige soon discovers that the previous Book Dispatcher suddenly ran away while alone on duty. Some say the customers were too harsh to him, but others claim a demonic barrel bin got him fired by stealing all the books. Regardless, Paige isn’t going to let some silly hearsay get in the way of her dream job. It’s not everyday you get the chance to work at BooksMart!",
